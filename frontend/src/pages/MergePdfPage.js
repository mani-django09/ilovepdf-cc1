        ...
        <>
          {(() => {
            ...
            const metaTags = [
              ...
              { property: "og:url", content: "https://ilovepdf8.com/merge-pdf" },
            ...
            canonical.setAttribute('href', 'https://ilovepdf8.com/merge-pdf')
          })()}
        </>
      )}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 lg:p-6 text-center group hover:shadow-lg transition-shadow duration-300">
              ...
              <Link to="/edit-pdf" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
                Edit PDFs →
              </Link>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 lg:p-6 text-center group hover:shadow-lg transition-shadow duration-300">
              ...
              <Link to="/split-pdf" className="text-purple-600 hover:text-purple-700 font-medium text-sm">
                Split PDFs →
              </Link>
            </div>
          </div>
